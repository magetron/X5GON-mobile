...
class testNavViewController: XCTestCase {
    ...
    func testLoginView() {
        ...
        nvc?.loginView.keyboardWillHide(notification: NSNotification(name: NSNotification.Name("hide"), object: true))
        nvc?.loginView.keyboardWillShow(notification: NSNotification(name: NSNotification.Name("show"), object: true))
