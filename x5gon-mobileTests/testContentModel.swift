...
class testContentModel: XCTestCase {
    let content = Content(title: "Test Content", id: 111, channelName: "Test Channel", description: "This is our test Content", url: URL(string: "www.testContent.com")!)
    ...
    func testContentURL() {
        ...
        let testUrl = URL(string: "www.testContent.com")!
    ...
    func testSelfDefinedEqual() {
        let contentTest = Content(title: "Test Content", id: 113, channelName: "Test Channel", description: "This is our test Content", url: URL(string: "www.testContent.com")!)
